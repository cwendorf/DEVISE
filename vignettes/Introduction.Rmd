...
title: "Introduction"
description: >
  This page outlines the general purpose and structure of the DAVISE workflow.
...
This page outlines the general purpose and structure of the DAVISE functions.

## Scope of the Project

DAVISE was designed to offer a simple, intuitive, and consistent way to implement estimation statistics in R. The following goals set the scope of the project:
...
DAVISE offers a general convention for function names. Each function is first comprised of a prefix (the verb that indicates what procedure should be conducted). These are the basic options (though more elaborate functions also exist):
